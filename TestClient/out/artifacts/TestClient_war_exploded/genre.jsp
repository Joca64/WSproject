...
<%
    if (request.getParameter("name") != null) {
        List<String> genreInfo = cliente.getGenre(request.getParameter("name"));
        if (genreInfo.size() == 0) {
%>
<script>
    alert("Genre not found, please try again.");
...
<div class="row">
    <center><h2>Genre - <%=genreInfo.get(0)%>
    </h2></center>
</div>
<div class="container-fluid">
    <div class="col-md-1"></div>
    <div class="col-md-10">
        <ul class="list-group">
            <%
                int counter = 0;
                String[] jogos = genreInfo.get(1).split("\\+");
