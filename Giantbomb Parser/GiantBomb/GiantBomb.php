...
class GiantBomb {
     ...
     * @type   string
     */
    private $api_key = "2d03380d725610b0fd52d04058beb84099422441";
    ...
    public function platform($id, $field_list = array())
    {
        return $this->get_object('platform', $id, $field_list);
    }

    public function franchise($id, $field_list = array())
    {
        return $this->get_object('franchise', $id, $field_list);
    }
